...
sed -i "/^DeploymentDir/c\DeploymentDir = \"\"" $CFG
...
sed -i "/^CustomBootstrapAddresses/c\CustomBootstrapAddresses = \"/ip4/46.101.186.142/tcp/2001/p2p/12D3KooWCz6iHZAJ6ocH2xnSJKdLeTgxg2VmnnAY8f9SM2C8e7uD\"" $CFG
